...
//						and on mouseleave check if scrolllock          
        ...
        if(!self.options.zoomEnabled){return false;}
				...
				//get relative offset (body->placezoom modification)
				var childPos = self.$elem.offset();
				var parentPos = self.$elem.parent().offset();
				self.childOffset = {
				...
				-> use relative offset : div "placezoom"
				*/
				self.zoomContainer.css({ top: self.childOffset.top});
				self.zoomContainer.css({ left: self.childOffset.left});
